...
typedef void(^ReturnBlockOfIndex)(NSInteger num);
typedef void(^ReturnBlockOfNum)(NSInteger num);

@interface CKCalendarCell : UIView

@property (nonatomic, strong) ReturnBlockOfIndex myReturnBlockOfIndex;
@property (nonatomic, strong) ReturnBlockOfNum myReturnBlockOfNum;
