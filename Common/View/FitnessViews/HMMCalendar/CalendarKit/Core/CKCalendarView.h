...
typedef void (^ReturnClickBlock)(NSInteger index, NSInteger num); // 回调 bLock
typedef void(^ReturnBlockOfIndexNext)(NSInteger num);
typedef void(^ReturnBlockOfNumNext)(NSInteger num);

@interface CKCalendarView : UIView

@property (nonatomic, strong) ReturnBlockOfIndexNext myReturnBlockOfIndexNext;
@property (nonatomic, strong) ReturnBlockOfNumNext myReturnBlockOfNumNext;
@property (nonatomic, assign) NSInteger index; // index
@property (nonatomic, assign) NSInteger num;

@property (nonatomic, strong) ReturnClickBlock returnClickBlock;
